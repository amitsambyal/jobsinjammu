"""
Django settings for jobsblog project.
...
SECRET_KEY = 'django-insecure-e#m68_kob9qhdxvc&^z*1d&5v81%+fn=6ub#v^c)3o_&zwq(8='

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['31.97.205.66', 'localhost', '127.0.0.1', '*']
...
WSGI_APPLICATION = 'jobsblog.wsgi.application'
...
MEDIA_URL = '/media/'
#MEDIA_URL='/var/www/angelschooldayalachak.com/media/'
